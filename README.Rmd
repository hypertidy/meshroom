...
hmmr::hmm_triangles(volcano)


hmmr::hmm_triangles(volcano, max_triangles = 50)
```

Now write to STL so we can [check it out](https://github.com/hypertidy/hmmr/blob/master/man/figures/volcano1.stl). 



```{r STL, eval=FALSE}
hmmr::hmm_triangles(volcano, z_exaggeration = 30, stl_file = "man/figures/volcano1.stl")
```
## notes
